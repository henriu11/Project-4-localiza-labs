...
namespace Api_lucas.Controllers
{
    ...
    public class InfectadoController : ControllerBase
    {
        ...
        {
            var infectado = new Infectado(dto.DataNascimento, dto.Sexo, dto.Latitude, dto.Longitude, dto.Comorbidade);
        ...
        {
            var infectados = new Infectado(dto.DataNascimento, dto.Sexo, dto.Latitude, dto.Longitude, dto.Comorbidade);
